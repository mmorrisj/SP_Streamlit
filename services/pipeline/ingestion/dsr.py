...
# Parsing and relationship-flattening logic lives in dsr_core so the API
# server can import it without the embedding stack. Re-exported here so
# existing callers of this module keep working.
from services.pipeline.ingestion.dsr_core import (  # noqa: F401
    split_multi,
    parse_date,
    parse_doc,
    document_text_fn,
    document_metadata_fn,
    flatten_events_to_raw_events,
    flatten_all_relationships,
)
