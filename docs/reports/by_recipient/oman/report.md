...
> **Hedging profile: balancing (multi-patron).** Lead actor: **Iran** (35% of external attention).

---

## 1. Key Judgments (BLUF)

- **Oman balances multiple patrons** — Iran leads (35%) but engages U.S., China substantially too. **(M)**
...
- **42.6% of U.S. coverage here is Iranian-media-framed** — a meaningful adversarial-narrative presence around the U.S. role. **(M)**
...
![Initiatives targeting Oman](assets/05_initiatives.png)
...
67 peripheral events (where Oman was only mentioned in
...
- **Iran-Oman Bilateral Cooperation Talks on Economic Sanctions and Joint Investments, May 2025** — Iran, material 8.00 (2025-05)
...
- **Adversarial framing:** 42.6% of the U.S.'s coverage in Oman is carried by Iranian media — its image here is partly written by its adversary. **(M)**
